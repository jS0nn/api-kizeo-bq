 ...
 * @param {string} fileId
 * @return {{contentUrl:string, viewUrl:string, lh3Url:string}}
 */
function buildDriveMediaUrls(fileId) {
  ...
  return {
    contentUrl: 'https://drive.google.com/uc?export=view&id=' + sanitized,
    viewUrl: 'https://drive.google.com/file/d/' + sanitized + '/view?usp=drivesdk',
    lh3Url: 'https://lh3.googleusercontent.com/d/' + sanitized + '=s0'
  };
}
