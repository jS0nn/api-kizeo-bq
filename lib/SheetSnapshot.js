(function (global) {
 ...
 function prepareSheet(sheetFormulaire, headers) {
   try {
      if (!sheetFormulaire || typeof sheetFormulaire.getLastRow !== 'function' || typeof sheetFormulaire.getRange !== 'function') {
 ...
 function getColumnIndices(values, headers, existingHeaders, sheetEnCours) {
   try {
      if (!sheetEnCours || typeof sheetEnCours.getLastColumn !== 'function' || typeof sheetEnCours.getRange !== 'function') {
