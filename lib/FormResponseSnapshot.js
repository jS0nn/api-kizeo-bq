...
function formSnapshotPersistSnapshot(spreadsheetBdD, formulaire, snapshot) {
  formSnapshotLegacyLog('persistSnapshot (FormResponseSnapshot): bypass legacy Sheets', {
...
var FormResponseSnapshot = {
  ...
  persistSnapshot: formSnapshotPersistSnapshot
};

var ExternalSnapshot = FormResponseSnapshot;

this.FormResponseSnapshot = FormResponseSnapshot;
this.ExternalSnapshot = FormResponseSnapshot;
