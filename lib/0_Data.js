...
var libKizeo = this.libKizeo || {};

if (typeof handleException === 'function') {
  libKizeo.handleException = handleException;
}
if (typeof requeteAPIDonnees === 'function') {
  libKizeo.requeteAPIDonnees = requeteAPIDonnees;
}
if (typeof processData === 'function') {
  libKizeo.processData = processData;
}
if (typeof handleResponses === 'function') {
  libKizeo.handleResponses = handleResponses;
}
if (typeof markResponsesAsRead === 'function') {
  libKizeo.markResponsesAsRead = markResponsesAsRead;
}
if (typeof createIngestionServices === 'function') {
  libKizeo.createIngestionServices = createIngestionServices;
}
if (typeof buildExecutionTargets === 'function') {
  libKizeo.buildExecutionTargets = buildExecutionTargets;
}
if (typeof resolveBatchLimit === 'function') {
  libKizeo.resolveBatchLimit = resolveBatchLimit;
}
if (typeof resolveIsoTimestamp === 'function') {
  libKizeo.resolveIsoTimestamp = resolveIsoTimestamp;
}
if (typeof resolveUnreadDataset === 'function') {
  libKizeo.resolveUnreadDataset = resolveUnreadDataset;
}
if (typeof collectResponseArtifacts === 'function') {
  libKizeo.collectResponseArtifacts = collectResponseArtifacts;
}
if (typeof ingestBigQueryPayloads === 'function') {
  libKizeo.ingestBigQueryPayloads = ingestBigQueryPayloads;
}
if (typeof runExternalListsSync === 'function') {
  libKizeo.runExternalListsSync = runExternalListsSync;
}
if (typeof initBigQueryConfig === 'function') {
  libKizeo.initBigQueryConfig = initBigQueryConfig;
}
if (typeof ensureBigQueryCoreTables === 'function') {
  libKizeo.ensureBigQueryCoreTables = ensureBigQueryCoreTables;
}
if (typeof getBigQueryConfig === 'function') {
  libKizeo.getBigQueryConfig = getBigQueryConfig;
}
if (typeof bqComputeTableName === 'function') {
  libKizeo.bqComputeTableName = bqComputeTableName;
}
if (typeof bqExtractAliasPart === 'function') {
  libKizeo.bqExtractAliasPart = bqExtractAliasPart;
}
if (typeof bqRunDeduplicationForForm === 'function') {
  libKizeo.bqRunDeduplicationForForm = bqRunDeduplicationForForm;
}
if (typeof bqParentTableId === 'function') {
  libKizeo.bqParentTableId = bqParentTableId;
}
if (typeof bqBackfillForm === 'function') {
  libKizeo.bqBackfillForm = bqBackfillForm;
}
if (typeof DriveMediaService !== 'undefined') {
  libKizeo.DriveMediaService = DriveMediaService;
}
if (typeof ExternalListsService !== 'undefined') {
  libKizeo.ExternalListsService = ExternalListsService;
}
if (typeof FormResponseSnapshot !== 'undefined') {
  libKizeo.FormResponseSnapshot = FormResponseSnapshot;
}
if (typeof gestionFeuilles === 'function') {
  libKizeo.gestionFeuilles = gestionFeuilles;
}
if (typeof isNumeric === 'function') {
  libKizeo.isNumeric = isNumeric;
}

this.libKizeo = libKizeo;
