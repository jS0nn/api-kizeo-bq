...
(function (global) {
  ...
  function createIngestionServices(overrides) {
    ...
    const defaultSnapshot =
      typeof global.FormResponseSnapshot !== 'undefined'
        ? global.FormResponseSnapshot
        : typeof global.ExternalSnapshot !== 'undefined'
        ? global.ExternalSnapshot
        : typeof global.SheetSnapshot !== 'undefined'
        ? global.SheetSnapshot
        : null;
    ...
    try {
      ...
      try {
        const externalService =
          typeof global.ExternalListsService !== 'undefined' &&
          global.ExternalListsService &&
          typeof global.ExternalListsService.updateFromSnapshot === 'function'
            ? global.ExternalListsService
            : null;

        const listeAjour = externalService
          ? externalService.updateFromSnapshot(formulaire, snapshot, {
              fetch: requester,
              handleException: typeof global.handleException === 'function' ? global.handleException : undefined,
              log
            })
          : typeof global.majListeExterne === 'function'
          ? global.majListeExterne(formulaire, snapshot)
          : 'IGNORED';
        ...
        if (typeof global.handleException === 'function') {
  ...
  function handleResponses(spreadsheetBdD, formulaire, apiPath, action, medias, hasPreviousRun, options) {
    try {
      ...
      const legacySheetSyncEnabled = false;
