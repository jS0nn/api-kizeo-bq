...
/**
 * @deprecated Migration BigQuery : persistance des sous-formulaires dans Sheets.
...
function gestionTableaux(spreadsheetBdD, formulaire, idReponse, nomTableau, tableau) {
  try {
    ...
    const newRows = createNewRows(tableau, idReponse, headers, formulaire, spreadsheetBdD);
 ...
 */
/**
 * @deprecated Migration BigQuery : création d’onglets Sheets.
 */
 ...
 */
/**
 * @deprecated Migration BigQuery : gestion des en-têtes pour Sheets.
 */
 ...
 */
/**
 * @deprecated Migration BigQuery : ajout de colonnes dans les onglets.
 */
 ...
 */
/**
 * @deprecated Migration BigQuery : génération de lignes Sheets pour sous-formulaires.
 */
function createNewRows(tableau, idReponse, headers, formulaire, spreadsheet) {
      ...
      if (row[header]) {
        ...
        if (type === 'photo' || type === 'signature') {
          const mediaInfo = gestionChampImage(
            ...
            value,
            spreadsheet,
            { fieldType: type, formName: formulaire.nom }
          );
          values.push(mediaInfo && mediaInfo.formula ? mediaInfo.formula : '');
        } else {
 ...
 */
/**
 * @deprecated Migration BigQuery : insertion de lignes dans Sheets.
 */
 ...
 */
/**
 * @deprecated Migration BigQuery : création de liens vers les onglets Sheets.
 */
