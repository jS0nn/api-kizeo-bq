...
// Exposition des fonctions nécessaires aux projets consommateurs
this.initBigQueryConfig = initBigQueryConfig;
this.ensureBigQueryCoreTables = ensureBigQueryCoreTables;
this.getBigQueryConfig = getBigQueryConfig;
this.bqComputeTableName = bqComputeTableName;
this.bqExtractAliasPart = bqExtractAliasPart;
this.bqRunDeduplicationForForm = bqRunDeduplicationForForm;
this.bqParentTableId = bqParentTableId;
