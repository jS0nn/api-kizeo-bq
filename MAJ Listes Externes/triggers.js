    ...
    : (function () {
        ...
        function persistTriggerFrequencyToSheet(frequencyKey) {
          try {
            ...
            if (typeof majConfig === 'undefined') return;
            var existingConfig = majConfig.readFormConfigFromSheet(activeSheet) || {};
            ...
            majConfig.writeFormConfigToSheet(activeSheet, mergedConfig);
          } catch (e) {
...
var TRIGGER_DISABLED_KEY = majTriggers.TRIGGER_DISABLED_KEY;
var TRIGGER_FREQUENCY_PROPERTY = majTriggers.TRIGGER_FREQUENCY_PROPERTY;
var TRIGGER_OPTIONS = majTriggers.TRIGGER_OPTIONS;
var DAILY_CUSTOM_TRIGGER_PATTERN = majTriggers.DAILY_CUSTOM_TRIGGER_PATTERN;
var WEEKLY_CUSTOM_TRIGGER_PATTERN = majTriggers.WEEKLY_CUSTOM_TRIGGER_PATTERN;
var WEEKDAY_CODE_MAP = majTriggers.WEEKDAY_CODE_MAP;
